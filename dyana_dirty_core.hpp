...
namespace dyana {
  ...
  enum trainer_type {
    SIMPLE_SGD, CYCLICAL_SGD, MOMENTUM_SGD, ADAGRAD, ADADELTA, RMS_PROP, ADAM, AMSGRAD, EXPONENTIATED_GRADIENT
  };
   ...
   */
  inline void
  initialize(unsigned num_workers = 1, trainer_type trainer = ADAM, float learning_rate = 0.01, unsigned memory = 512) {
