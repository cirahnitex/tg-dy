...
namespace dyana {
  ...
  inline dyana::tensor
  maxpooling2d(const dyana::tensor &x, unsigned window_width, unsigned window_height, unsigned stride_between_rows,
               unsigned stride_between_columns, bool disable_padding = true) {
    return dynet::maxpooling2d(x, {window_width, window_height}, {stride_between_rows, stride_between_columns},
                               disable_padding);
  }

  inline std::vector<dyana::tensor>
  maxpooling1d(const std::vector<dyana::tensor> &xs, unsigned window_length, unsigned stride,
  ...
  public:
    ...
    std::vector<dyana::tensor> operator()(const std::vector<dyana::tensor> &xs) {
